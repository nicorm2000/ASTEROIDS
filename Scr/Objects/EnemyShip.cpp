...
{
	DrawRectangleLines(enemyShip.position.x, enemyShip.position.y, enemyShip.size.x, enemyShip.size.y, RED);
	DrawTextureTiled(enemyShip.enemyTexture, enemyShip.source, enemyShip.dest, enemyShip.origin, enemyShip.rotation, 2, WHITE);
}